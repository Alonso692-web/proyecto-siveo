...
function generaBotones(categoria) {
  let Botones = '<ul class="orderDatatable_actions mb-0 d-flex flex-wrap">' 
  Botones  +='<li>'
  Botones  +='<a href="#" class="view" class="btn btn-success btn-default btn-squared " data-bs-toggle="modal" data-bs-target="#viewModal">'
  Botones  +='<i class="uil uil-eye"></i>'
  Botones  +='</a>'
  Botones  +='</li>'
  Botones  +='<li>'
  Botones  +='<a href="#" class="edit" class="btn btn-success btn-default btn-squared " data-bs-toggle="modal" data-bs-target="#updateModal">'
  Botones  +='<i class="uil uil-edit"></i>'
  Botones  +='</a>'
  Botones  +='</li>'
  Botones  +='<li>'
  Botones  +='<a href="#" class="remove" type="button" class="btn btn-outline-lighten btn-outline-lighten__height" data-bs-toggle="modal" data-bs-target="#modal-info-delete">'
  Botones  +='<i class="uil uil-trash-alt"></i>'
  Botones  +='</a>'
  Botones  +='</li>'
  Botones  +='</ul>';
  return Botones;
